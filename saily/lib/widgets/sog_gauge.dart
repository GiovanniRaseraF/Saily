                        ...
                        RadialAxis(
                            ...
                            GaugeRange(
                              ...
                              GaugeRange(
                                  ...
                                  gradient: SweepGradient(colors: [SailyBlue, SailyOrange, Colors.red]),
                                  startWidth: 5,
                              ...
                              GaugeAnnotation(
                                  widget: Container(
                                    child: Row(
                                      ...
                                      children: [
                                      Text("${gpsData.SOG.toStringAsFixed(1)}",
                                          style: TextStyle(
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold)),
                                      StreamBuilder(
                                        stream:
                                            settingsController.getSogUnitStream(),
                                        builder: (c, sn) {
                                          if (sn.data != null) {
                                            unit = sn.data!;
                                          }
                        ...
                        RadialAxis(
                            ...
                            GaugeRange(
                              ...
                              GaugeRange(
                                  ...
                                  gradient: SweepGradient(colors: [SailyLightGreen]),
                                  startWidth: 5,
                                  endWidth: (15 / 150) * gpsData.SOG),
                            ],
                            pointers: [
                              ...
                              GaugeAnnotation(
                                  widget: Container(
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                      Text("${(gpsData.SOG *50).toStringAsFixed(0)}",
                                          style: TextStyle(
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold)),
